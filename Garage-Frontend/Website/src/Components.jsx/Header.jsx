  ...
  return (
    ...
    <div className='w-screen h-20 fixed top-0 left-0 z-50 bg-transparent backdrop-blur-md hover:bg-black transition-all duration-300'>
     ...
     <div className=" pt-6 flex flex-row space-x-18 mx-105">
       <Link as={Link} to="/home" ><i className="fa-solid fa-house-chimney text-2xl text-lime-500 bg-transparent hover:text-gray-400 cursor-pointer"></i></Link>
    <Link as={Link} to="/about">  <i className="fa-solid fa-car text-2xl text-gray-400"></i></Link>
